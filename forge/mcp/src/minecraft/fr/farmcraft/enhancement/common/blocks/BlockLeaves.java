...
public class BlockLeaves extends BlockContainer implements IShearable {
    ...
    public void onBlockAdded(World world, int x, int y, int z) {
    	...
    	if( meta == 0 && world.rand.nextInt(200) == 0 ) meta = 12;
