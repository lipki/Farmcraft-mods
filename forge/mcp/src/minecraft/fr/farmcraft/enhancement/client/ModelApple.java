...
public class ModelApple extends ModelBase {
    ...
    public ModelRenderer  apple = (new ModelRenderer(this,0,16)).addBox(-8, -10, 0, 16, 16, 0);
    public ModelRenderer apple2 = (new ModelRenderer(this,0,16)).addBox(-8, -10, 0, 16, 16, 0);
    public ModelRenderer apple3 = (new ModelRenderer(this,0, 0)).addBox(-8,  -8, 0, 16, 16, 0);
    ...
    public ModelApple() {
         ...
         this.apple3.rotateAngleX = (float) Math.PI/2;
    }

    public void render() {
         this.apple.render(0.03125F);
        this.apple2.render(0.03125F);
        this.apple3.render(0.03125F);
    }
}
